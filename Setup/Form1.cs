...
namespace Setup
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            var config = DeviceConfig.Load("C:\\Users\\Automation\\GIT\\XC32_VSCODE_PROJ_BUILDER\\Setup\\device_config.json ");
            ...
            {
                textBoxPREFEN.Text = preconBits.TryGetValue("PREFEN", out var prefen) ? prefen : "";
                textBoxPFMWS.Text = preconBits.TryGetValue("PFMWS", out var pfmws) ? pfmws : "";
                textBoxECCCON.Text = preconBits.TryGetValue("ECCCON", out var ecccon) ? ecccon : "";
            }
        }
